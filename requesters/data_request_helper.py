...
class FinancialDataRequester:
    ...
    def __init__(self, index_id:str, dataset_name:str, 
                 rebalance_dates: list[str], reporting_frequency: str, start_date: str):
        """
    ...
    def get_rebalance_dates(self) -> pd.DataFrame:
        ...
        df_concat = df_concat[df_concat['AS_OF_DATE'] >= self.start_date]
    ...
    def _get_reporting_dates_per_rebalance(self, date: str, index: str):
        ...
        field = self._bq.data.sales_rev_turn(dates=bq.func.range('-6Y','0D'), fa_period_type=self.reporting_period)
        # Request the data
