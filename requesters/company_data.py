...
class SecurityData:
    ...
    def get_security_all_data(self, date: str, security: str) -> dict:
        """
        Return all data on a security by date.
        date: str - as of date for security information
        security: str - security for information request
        """
        security_data = {
